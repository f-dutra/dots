...
static const char *fonts[]          = { "monospace:size=13", "NotoColorEmoji:pixelsize=20:antialias=true:autohint=true", "MonaspiceNe NF:pixelsize=20:antialias=true:autohint=true" };
static const char dmenufont[]         = "monospace:size=13";

static const int hidevacant		   = 0;
static const int showbar              = 1;        /* 0 means no bar */

#include "themes/black.h"
